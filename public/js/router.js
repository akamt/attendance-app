...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open '/Users/kaneko/study/attendance-app/laravel/node_modules/vue/dist/vue.common.js'");
...
/* harmony default export */ __webpack_exports__["default"] = (new __WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]({
    mode: 'history',
    routes: [{ path: '/', component: __webpack_require__(37) }, { path: '/about', component: __webpack_require__(39) }, { path: '/expense', component: __webpack_require__(42) }]
}));
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("router-link", { attrs: { to: "/expense" } }, [_vm._v("Expense")])
    ],
    1
  )
}
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open '/Users/kaneko/study/attendance-app/laravel/node_modules/vue-loader/lib/component-normalizer.js'");
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("p", [_c("router-link", { attrs: { to: "/" } }, [_vm._v("戻る")])], 1)
  ])
}
var staticRenderFns = []
render._withStripped = true
...
Component.options.__file = "resources/assets/js/components/Expense.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3ed20f1e", Component.options)
  } else {
    hotAPI.reload("data-v-3ed20f1e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__services_http__ = __webpack_require__(25);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        __WEBPACK_IMPORTED_MODULE_0__services_http__["a" /* default */].get();
    },
    ...
    methods: {
        add: function add() {
            ...
            __WEBPACK_IMPORTED_MODULE_0__services_http__["a" /* default */].post('expenses', data, function (res) {
                console.log(res);
            });
        }
    }
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open '/Users/kaneko/study/attendance-app/laravel/node_modules/is-buffer/index.js'");
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("el-input", {
        attrs: { placeholder: "経費名", clearable: "" },
        model: {
          value: _vm.name,
          callback: function($$v) {
            _vm.name = $$v
      ...
      _vm._v(" "),
      _c("el-input", {
        attrs: { placeholder: "値段", clearable: "" },
        model: {
          value: _vm.value,
          callback: function($$v) {
            _vm.value = $$v
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-3ed20f1e", module.exports)
  }
}
